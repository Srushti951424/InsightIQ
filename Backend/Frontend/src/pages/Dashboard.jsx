...
export default function Dashboard() {
  ...
  const metricLabel = dashboard.primaryMetric
    ? dashboard.primaryMetric.replace(/_/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())
    : 'Value'
      ...
      <section className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <div className="ledger-rule bg-white/60 p-5 pt-6 md:col-span-2">
            <p className="eyebrow">{metricLabel} trend</p>
          ...
          <div className="ledger-rule bg-white/60 p-5 pt-6">
            <p className="eyebrow">{metricLabel} by category</p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          <div className="ledger-rule bg-white/60 p-5 pt-6">
            <p className="eyebrow">{metricLabel} by region</p>
            <div className="mt-4 h-48">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={dashboard.byRegion}>
                  ...
                  <Tooltip contentStyle={{ fontFamily: 'IBM Plex Mono', fontSize: 12, borderRadius: 2 }} formatter={(v) => [v, metricLabel]} />
